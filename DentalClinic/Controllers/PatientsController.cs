...
namespace DentalClinic.Controllers
{
    ...
    public class PatientsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PatientId,Name,LastName,Age,DateOfBirth")] Patient patient)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PatientId,Name,LastName,Age,DateOfBirth")] Patient patient)
        {
